$(window).ready(()=>{
    ...
    babyEye.prepareTrain = (infor)=>{
        ...
        function selectDifficulty(){
            let BG = new createjs.Bitmap(babyEye.prepareTrainQueue.getResult("BG"));
            stage.addChild(BG);
        ...
        function loadResource(onComplete){
            ...
            let path = infor.staticPath + "img/version5";
            ...
            let background = ["selectGlassesBG.png", "instructionBG.png", "selectEyeBG.png", "BG.png","selectMode.png"]
