...
$(window).ready(function () {
    var STBG = function () {
        function STBG(config) {
            ...
            var path = null;
            // if(!this.config.pathType || this.config.pathType == "formal"){
            //     path = "https://game.babyeye.com/";
            // }else if(this.config.pathType == "dev"){
            //     path = "http://t.test.babyeye.com/";
            // }

            // if(/^https/.test(window.location.href)){
            //     path = "https://game.babyeye.com/";
            // }else if(/t.test/.test(window.location.href) || /^http:\/\/[0-9]/.test(window.location.href)){
            //     path = "http://t.test.babyeye.com/"
            // }else{
            //     path = "http://t.babyeye.com/"
            // }

            if (/^http:\/\/[0-9]/.test(window.location.href)) {
                path = "http://t.test.babyeye.com/";
            } else {
                path = "//game.babyeye.com/";
            }

            window.bgQueue.loadManifest([{ id: "black-white-bar", src: path + "program/old-bird/static/img/stbg/bg1/black-white-bar.png" }, { id: "white-black-bar", src: path + "program/old-bird/static/img/stbg/bg1/white-black-bar.png" }, { id: "yellow-red-bar", src: path + "program/old-bird/static/img/stbg/bg1/yellow-red-bar.png" }, { id: "red-yellow-bar", src: path + "program/old-bird/static/img/stbg/bg1/red-yellow-bar.png" }, { id: "black-white-box", src: path + "program/old-bird/static/img/stbg/bg1/black-white-box.png" }, { id: "white-black-box", src: path + "program/old-bird/static/img/stbg/bg1/white-black-box.png" }, { id: "yellow-red-box", src: path + "program/old-bird/static/img/stbg/bg1/yellow-red-box.png" }, { id: "red-yellow-box", src: path + "program/old-bird/static/img/stbg/bg1/red-yellow-box.png" }]);
        }
