...
$(window).ready(function () {
    ...
    babyEye.prepareTrain = function (infor) {
        ...
        function selectDifficulty() {
            var BG = new createjs.Bitmap(babyEye.prepareTrainQueue.getResult("skyBG"));
            stage.addChild(BG);
            ...
            var TargetFU = function () {
                ...
                _createClass(TargetFU, [{
                    ...
                    value: function setView() {
                        ...
                        if (squint == "esotropia") {
                            ;
                            var _ref = [this.targetRight, this.targetLeft];
                            this.targetLeft = _ref[0];
                            this.targetRight = _ref[1];
                    ...
                    value: function handleConfirm() {
                        ...
                        if (bgIDs[currentBGIndex]) {
                            ...
                            var _ref2 = [this.targetLeftCommand.style, this.targetRightCommand.style];
                            this.targetRightCommand.style = _ref2[0];
                            this.targetLeftCommand.style = _ref2[1];
                        } else {
                            this.complete = true;
        ...
        function loadResource(onComplete) {
            ...
            var background = ["selectGlassesBG.png", "instructionBG.png", "selectEyeBG.png", "skyBG.png", "selectMode.png"].map(function (name) {
